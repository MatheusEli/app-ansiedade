  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cadastro-cadastro-module"], {
    ...
    function srcAppCadastroCadastroPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CadastroPage = /*#__PURE__*/function () {
        function CadastroPage(storage, authservice, router, usuarioService, fb) {
        ...
        _createClass(CadastroPage, [{
          ...
          value: function register() {
            ...
            if (this.validateForm(this.form.controls['email'].value, this.form.controls['senha'].value)) {
              this.authservice.registerWithEmail(this.form.controls['email'].value, this.form.controls['senha'].value).then(function () {
                _this2.message = "Cadastrado no app com sucesso!";

                _this2.usuarioService.createOrUpdate(_this2.form.value);

                _this2.form.reset();
              })["catch"](function (_error) {
                _this2.error = _error;
                _this2.message = "Não foi possível realizar seu cadastro";
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      path = "usuarios/".concat(new Date().getTime().toString());
                      fileRef = this.storage.ref(path);
                      this.task = this.storage.upload(path, file);
                      this.task.then(function (up) {
